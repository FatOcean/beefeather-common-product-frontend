...
const documents = [
  ...
  },
  {
    ...
    "pages": [
      {
        "img": exampleTwo,
        "excelPath": "product/qualification_certificate_analysis/demo/result/示例二.xlsx",
        "name": "示例.jpg",
        "originalHeight": 2419,
        "originalWidth": 1814,
        "imgRotatingDeg": 0,
        "analysisResult": [
          ...
          },
          {
            ...
            "key": "资质等级",
            "value": "建筑行业(建筑工程)甲级。可承担建筑装饰工程设计、建筑幕墙工程设计、轻型钢结构工程设计、建筑智能化系统设计、照明工程设计和消防设施工程设计相应范围的甲级专项工程设计业务,可从事资质证书许可范围内相应的建设工程总承包业务以及项目管理和相关的技术与管理服务。******",
            "coordinatesList": [
              {
                "x": 1035,
                "y": 474
